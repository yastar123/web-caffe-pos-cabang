    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-slide-up">
        ...
        <div className="flex items-center gap-2 flex-wrap shrink-0">
          <Badge variant="outline" className="text-xs px-3 py-1.5 bg-background gap-1.5 font-medium">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 stagger-children">
        {kpiCards.map((card) => (
          ...
          >
            <div className={cn("absolute inset-x-0 top-0 h-20 bg-gradient-to-b opacity-60 pointer-events-none", card.gradient)} />
            ...
            {isLowStockLoading ? (
              ...
              <div className="space-y-2.5 stagger-children">
                {lowStock.map((item: any) => {
                  ...
                  return (
                    <div key={item.ingredientId} className="p-3 rounded-xl border border-destructive/25 bg-gradient-to-r from-destructive/8 to-destructive/3 hover:from-destructive/12 transition-all">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-bold text-sm truncate flex-1 mr-2">{item.ingredientName}</span>
                        <div className="shrink-0 text-right">
                          <span className="font-black text-destructive text-sm tabular-nums">{item.currentStock}</span>
